    ...
    <div>
      ...
      <div className="space-y-5 text-lg	font-medium leading-7">
        <p>
          ...
          dedicated to crafting captivating web experiences. My expertise lies
          in leveraging cutting-edge technologies, specializing in development
          with React, Next.js, and Remix.
        </p>
        <p>
          I wield Tailwind CSS to style my creations with both elegance and
          efficiency. Beyond that, I love working with modern databases, and my
          current go-to is Supabase, providing an unparalleled development
          experience.
        </p>
        <p>
